...
export function Tile({
  ...
  value = 0,
  size = 'md',
  owner = null,           // null | "p1" | "p2" — neon edge for co-op/versus ownership
  onClick,
  onContextMenu,
  style = {},
}) {
  ...
  return (
    ...
    >
      {state === 'flagged' && <span style={{ color: 'var(--flag)', filter: 'drop-shadow(0 0 6px var(--flag))', fontSize: `calc(${px} * 0.5)` }}>⚑</span>}
